        ...
        <Card>
          ...
          <Card.Body>
            <div className="flex items-center justify-between mb-6">
              <Button
                onClick={handleShow}
                className="bg-blue-600 hover:bg-blue-700 text-white font-medium px-5 py-2.5 rounded-md transition-colors duration-200 border-0 shadow-sm hover:shadow flex items-center"
              >
